...
const Data = () => {
    return(
      <div className="home_data">
        <h1 className ="home_title">Keshav Sharma
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <p className ="home_desciption"> I'm a Web Developer based in India, and I'm very passionate and dedicated to my work.</p>
